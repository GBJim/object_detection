...
import protos.grid_anchor_generator_pb2
import protos.ssd_anchor_generator_pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/anchor_generator.proto',
  package='object_detection.protos',
  serialized_pb=_b('\n\x1dprotos/anchor_generator.proto\x12\x17object_detection.protos\x1a\"protos/grid_anchor_generator.proto\x1a!protos/ssd_anchor_generator.proto\"\xc7\x01\n\x0f\x41nchorGenerator\x12M\n\x15grid_anchor_generator\x18\x01 \x01(\x0b\x32,.object_detection.protos.GridAnchorGeneratorH\x00\x12K\n\x14ssd_anchor_generator\x18\x02 \x01(\x0b\x32+.object_detection.protos.SsdAnchorGeneratorH\x00\x42\x18\n\x16\x61nchor_generator_oneof')
  ,
  dependencies=[protos.grid_anchor_generator_pb2.DESCRIPTOR,protos.ssd_anchor_generator_pb2.DESCRIPTOR,])
...
_ANCHORGENERATOR.fields_by_name['grid_anchor_generator'].message_type = protos.grid_anchor_generator_pb2._GRIDANCHORGENERATOR
_ANCHORGENERATOR.fields_by_name['ssd_anchor_generator'].message_type = protos.ssd_anchor_generator_pb2._SSDANCHORGENERATOR
