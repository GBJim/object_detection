...
import protos.faster_rcnn_box_coder_pb2
import protos.mean_stddev_box_coder_pb2
import protos.square_box_coder_pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/box_coder.proto',
  package='object_detection.protos',
  serialized_pb=_b('\n\x16protos/box_coder.proto\x12\x17object_detection.protos\x1a\"protos/faster_rcnn_box_coder.proto\x1a\"protos/mean_stddev_box_coder.proto\x1a\x1dprotos/square_box_coder.proto\"\xfe\x01\n\x08\x42oxCoder\x12L\n\x15\x66\x61ster_rcnn_box_coder\x18\x01 \x01(\x0b\x32+.object_detection.protos.FasterRcnnBoxCoderH\x00\x12L\n\x15mean_stddev_box_coder\x18\x02 \x01(\x0b\x32+.object_detection.protos.MeanStddevBoxCoderH\x00\x12\x43\n\x10square_box_coder\x18\x03 \x01(\x0b\x32\'.object_detection.protos.SquareBoxCoderH\x00\x42\x11\n\x0f\x62ox_coder_oneof')
  ,
  dependencies=[protos.faster_rcnn_box_coder_pb2.DESCRIPTOR,protos.mean_stddev_box_coder_pb2.DESCRIPTOR,protos.square_box_coder_pb2.DESCRIPTOR,])
...
_BOXCODER.fields_by_name['faster_rcnn_box_coder'].message_type = protos.faster_rcnn_box_coder_pb2._FASTERRCNNBOXCODER
_BOXCODER.fields_by_name['mean_stddev_box_coder'].message_type = protos.mean_stddev_box_coder_pb2._MEANSTDDEVBOXCODER
_BOXCODER.fields_by_name['square_box_coder'].message_type = protos.square_box_coder_pb2._SQUAREBOXCODER
