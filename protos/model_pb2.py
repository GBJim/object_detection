...
import protos.faster_rcnn_pb2
import protos.ssd_pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/model.proto',
  package='object_detection.protos',
  serialized_pb=_b('\n\x12protos/model.proto\x12\x17object_detection.protos\x1a\x18protos/faster_rcnn.proto\x1a\x10protos/ssd.proto\"\x82\x01\n\x0e\x44\x65tectionModel\x12:\n\x0b\x66\x61ster_rcnn\x18\x01 \x01(\x0b\x32#.object_detection.protos.FasterRcnnH\x00\x12+\n\x03ssd\x18\x02 \x01(\x0b\x32\x1c.object_detection.protos.SsdH\x00\x42\x07\n\x05model')
  ,
  dependencies=[protos.faster_rcnn_pb2.DESCRIPTOR,protos.ssd_pb2.DESCRIPTOR,])
...
_DETECTIONMODEL.fields_by_name['faster_rcnn'].message_type = protos.faster_rcnn_pb2._FASTERRCNN
_DETECTIONMODEL.fields_by_name['ssd'].message_type = protos.ssd_pb2._SSD
