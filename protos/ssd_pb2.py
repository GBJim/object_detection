...
import protos.anchor_generator_pb2
import protos.box_coder_pb2
import protos.box_predictor_pb2
import protos.hyperparams_pb2
import protos.image_resizer_pb2
import protos.matcher_pb2
import protos.losses_pb2
import protos.post_processing_pb2
import protos.region_similarity_calculator_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[protos.anchor_generator_pb2.DESCRIPTOR,protos.box_coder_pb2.DESCRIPTOR,protos.box_predictor_pb2.DESCRIPTOR,protos.hyperparams_pb2.DESCRIPTOR,protos.image_resizer_pb2.DESCRIPTOR,protos.matcher_pb2.DESCRIPTOR,protos.losses_pb2.DESCRIPTOR,protos.post_processing_pb2.DESCRIPTOR,protos.region_similarity_calculator_pb2.DESCRIPTOR,])
...
_SSD.fields_by_name['image_resizer'].message_type = protos.image_resizer_pb2._IMAGERESIZER
_SSD.fields_by_name['feature_extractor'].message_type = _SSDFEATUREEXTRACTOR
_SSD.fields_by_name['box_coder'].message_type = protos.box_coder_pb2._BOXCODER
_SSD.fields_by_name['matcher'].message_type = protos.matcher_pb2._MATCHER
_SSD.fields_by_name['similarity_calculator'].message_type = protos.region_similarity_calculator_pb2._REGIONSIMILARITYCALCULATOR
_SSD.fields_by_name['box_predictor'].message_type = protos.box_predictor_pb2._BOXPREDICTOR
_SSD.fields_by_name['anchor_generator'].message_type = protos.anchor_generator_pb2._ANCHORGENERATOR
_SSD.fields_by_name['post_processing'].message_type = protos.post_processing_pb2._POSTPROCESSING
_SSD.fields_by_name['loss'].message_type = protos.losses_pb2._LOSS
_SSDFEATUREEXTRACTOR.fields_by_name['conv_hyperparams'].message_type = protos.hyperparams_pb2._HYPERPARAMS
